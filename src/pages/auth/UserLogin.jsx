          ...
          <div className='flex justify-center items-center mt-5 md:mt-10'>
            <div className='w-full p-4 sm:p-0 sm:w-1/2  flex flex-col gap-3'>
              ...
              <InputWithLabel label={'Password'} type='password' value={loginForm.password}
                ...
                handleChange={handleChange}
              />
              <Button handlClick={() => navigate('/')} text={"Login"} className={'py-2 hover:bg-transparent hover:border border-neutral-500 hover:text-black text-2xl my-1 hover:scale-105 duration-500 transition-transform'} />
                <span className='text-center text-xl text-neutral-500'>Or</span>
                <Button handlClick={() => navigate('/auth/user-register')} text={"Sign Up"} className={'py-2 hover:bg-transparent hover:border border-neutral-500 hover:text-black text-2xl my-1 hover:scale-105 duration-500 transition-transform'} />
