...
const BoyKidsWearAllProducts = () => {
    ...
    return (
        <>
        <h3 className="text-3xl font-bold my-20 text-center ">BOY'S CLOTHING </h3>
...

                    {
                        [1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                            <div className='bg-white shadow-xl p-6 rounded-lg w-full hover:bg-slate-100 cursor-pointer ' key={i}>
                                <img
                                    src='https://img.freepik.com/free-photo/child-wearing-knit-hat-studio_53876-97002.jpg?t=st=1727979554~exp=1727983154~hmac=f4e38c9fef51567f330c2a53e2ab8c0150bbe06aace633fcf58b9d3d59356200&w=360'
...
export default BoyKidsWearAllProducts;
