...
const GirlKidsWearAllProducts = () => {
    ...
    return (
        <>
        <h3 className="text-3xl font-bold my-20 text-center ">GIRL'S CLOTHING </h3>
...

                    {
                        [1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                            <div className='bg-white shadow-xl p-6 rounded-lg w-full hover:bg-slate-100 cursor-pointer ' key={i}>
                                <img
                                    src='https://img.freepik.com/free-photo/adorable-little-girl-lifting-her-hat_23-2148329753.jpg?t=st=1727979777~exp=1727983377~hmac=45638d209b1bd4f7554574b609b5027539d4a098e3e75f50fa2225a159b835b9&w=360'
...
export default GirlKidsWearAllProducts;
